...
describe('SupplierService', () => {
	...
	describe('create', () => {
		it('should create a supplier', async () => {
			const supplierData: Prisma.SupplierCreateInput = { name: 'Test Supplier', user };
			const createdSupplier: Supplier = { id: 1, name: 'Test Supplier', userId: 1, createdAt: new Date(), updatedAt: new Date() };
	...
	describe('update', () => {
		it('should update a supplier', async () => {
			const supplierData: Prisma.SupplierUpdateInput = { name: 'Updated Supplier' };
			const updatedSupplier: Supplier = { id: 1, name: 'Updated Supplier', userId: 1, createdAt: new Date(), updatedAt: new Date() };
	...
	describe('get', () => {
		it('should return a supplier by id', async () => {
			const supplier: Supplier = { id: 1, name: 'Test Supplier', userId: 1, createdAt: new Date(), updatedAt: new Date() };
	...
	describe('getAll', () => {
		it('should return all suppliers for a user', async () => {
			const suppliers: Supplier[] = [
				{ id: 1, name: 'Supplier 1', userId: 1, createdAt: new Date(), updatedAt: new Date() },
				{ id: 2, name: 'Supplier 2', userId: 1, createdAt: new Date(), updatedAt: new Date() },
			];
