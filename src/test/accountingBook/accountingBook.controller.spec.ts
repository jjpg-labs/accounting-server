...
describe('AccountingBookController', () => {
	...
	const user: Prisma.UserCreateNestedOneWithoutAccountingBooksInput = { connect: { id: 1 } };
			...
			providers: [
				{
					...
					useValue: {
						createAccountingBook: jest.fn().mockResolvedValue({ id: 1, name: 'Test Book' }),
	...
	describe('createAccountingBook', () => {
		it('should create a new accounting book', async () => {
			const data: Prisma.AccountingBookCreateInput = { name: 'Test Book', user };
